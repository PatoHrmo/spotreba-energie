...
public class BeanTableModel<T> extends RowTableModel<T> {
    ...
    private final static Map<Class, Class> primitives = new HashMap<Class, Class>(10);
    ...
    private final List<ColumnInformation> columns = new ArrayList<>();
    ...
    private void buildColumnInformation(Method theMethod, String theMethodName) {
        ...
        ColumnInformation ci = new ColumnInformation(headerName, returnType, theMethod, setMethod, displayPriority);
        columns.add(ci);
    }
    ...
    private class ColumnInformation implements Comparable<ColumnInformation> {
        ...
        public ColumnInformation(String name, Class returnType, Method getter, Method setter, int displayPriority) {
            this.name = name;
        ...
        public int compareTo(ColumnInformation o) {
            int p = displayPriority - o.displayPriority;
            if (p == 0) {
