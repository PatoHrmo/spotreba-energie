...
select cislo_odberatela, meno||' '||priezvisko meno, meracia_velicina, get_spotreba_za_obdobie(cislo_odberatela,to_date('1.1.2016','dd.mm.yyyy'),to_date('1.1.2017','dd.mm.yyyy'),meracia_velicina) spotreba
