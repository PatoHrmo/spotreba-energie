...
--select * from table(get_znizena_miera_spotreby(to_date('8.1.2016','dd.mm.yyyy'),to_date('8.1.2017','dd.mm.yyyy'),0.1));
...
/
create or replace function get_znizena_miera_spotreby(
    datum_od date,
    datum_do date,
    faktor_zvysenia number
)
...
begin
  ...
  return zaznamy;
end get_znizena_miera_spotreby;